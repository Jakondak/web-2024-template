    ...
    if (recipes.length === 0) {
      const boilerplateRecipes: Recipe[] = [
        ...
        },
        {
          ...
          instructions: "Cut chicken. Stir fry vegetables. Add chicken and soy sauce. Cook until done.",
          servings: 3,
        },
        {
          id: 3,
          ...
          instructions: "Chop vegetables. Mix all ingredients. Add olive oil and oregano.",
          servings: 4,
        },
        {
          id: 4,
        ...
        },
        {
          ...
          instructions: "Chop vegetables. Sauté onion and garlic. Add vegetables and stock. Simmer until cooked.",
          servings: 4,
        },
      ];
